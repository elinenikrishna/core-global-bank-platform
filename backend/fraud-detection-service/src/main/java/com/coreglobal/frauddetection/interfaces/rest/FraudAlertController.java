...
import com.coreglobal.frauddetection.application.FraudAlertApplicationService;
...
public class FraudAlertController {
    private final FraudAlertApplicationService service;
    public FraudAlertController(FraudAlertApplicationService service) { this.service = service; }

    @GetMapping(produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    public ApiEnvelope<Page<FraudAlertRecord>> find(@RequestParam(required = false) String owner, Pageable pageable, HttpServletRequest request) {
