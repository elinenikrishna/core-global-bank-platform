...
import com.coreglobal.transaction.application.TransactionApplicationService;
...
public class TransactionController {
    ...
    public TransactionController(TransactionApplicationService service) { this.service = service; }

    @GetMapping(produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    public ApiEnvelope<Page<TransactionRecord>> find(@RequestParam(required = false) String owner, Pageable pageable, HttpServletRequest request) {
