...
import com.coreglobal.chatbot.application.ChatbotApplicationService;
...
public class ChatbotController {
    private final ChatbotApplicationService service;
    public ChatbotController(ChatbotApplicationService service) { this.service = service; }

    @GetMapping(produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    public ApiEnvelope<Page<ChatbotRecord>> find(@RequestParam(required = false) String owner, Pageable pageable, HttpServletRequest request) {
