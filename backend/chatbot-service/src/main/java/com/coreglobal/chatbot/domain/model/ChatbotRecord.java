package com.coreglobal.chatbot.domain.model;
...
@Entity
@Table(name = "CGB_chatbot", indexes = {
    @Index(name = "IDX_CHATBOT_OWNER", columnList = "ownerId"),
    @Index(name = "IDX_CHATBOT_STATUS", columnList = "status")
})
public class ChatbotRecord extends AuditableEntity {
    ...
    protected ChatbotRecord() {}
    public ChatbotRecord(String reference, String ownerId, String status, BigDecimal amount, String details) {
