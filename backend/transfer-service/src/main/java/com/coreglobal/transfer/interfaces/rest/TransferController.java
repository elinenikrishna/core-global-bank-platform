package com.coreglobal.transfer.interfaces.rest;
...
import com.coreglobal.transfer.application.TransferApplicationService;
...
public class TransferController {
    ...
    public TransferController(TransferApplicationService service) { this.service = service; }

    @GetMapping(produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    public ApiEnvelope<Page<TransferRecord>> find(@RequestParam(required = false) String owner, Pageable pageable, HttpServletRequest request) {
