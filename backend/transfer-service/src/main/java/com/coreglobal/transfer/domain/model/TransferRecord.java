package com.coreglobal.transfer.domain.model;
...
@Entity
@Table(name = "CGB_transfers", indexes = {
    @Index(name = "IDX_TRANSFER_OWNER", columnList = "ownerId"),
    @Index(name = "IDX_TRANSFER_STATUS", columnList = "status")
})
public class TransferRecord extends AuditableEntity {
    ...
    public TransferRecord(String reference, String ownerId, String status, BigDecimal amount, String details) {
