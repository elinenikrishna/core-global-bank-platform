package com.coreglobal.customer.interfaces.rest;
...
import com.coreglobal.customer.application.CustomerApplicationService;
...
public class CustomerController {
    ...
    public ApiEnvelope<Page<CustomerRecord>> find(@RequestParam(required = false) String owner, Pageable pageable, HttpServletRequest request) {
