package com.coreglobal.auth.domain.model;
...
@Entity
@Table(name = "CGB_auth", indexes = {
    @Index(name = "IDX_AUTH_OWNER", columnList = "ownerId"),
    @Index(name = "IDX_AUTH_STATUS", columnList = "status")
})
public class AuthRecord extends AuditableEntity {
    ...
    public AuthRecord(String reference, String ownerId, String status, BigDecimal amount, String details) {
