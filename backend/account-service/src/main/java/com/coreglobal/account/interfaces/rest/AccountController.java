package com.coreglobal.account.interfaces.rest;
...
import com.coreglobal.account.application.AccountApplicationService;
...
public class AccountController {
    ...
    public ApiEnvelope<Page<AccountRecord>> find(@RequestParam(required = false) String owner, Pageable pageable, HttpServletRequest request) {
