package com.coreglobal.account.domain.model;
...
@Entity
@Table(name = "CGB_accounts", indexes = {
    @Index(name = "IDX_ACCOUNT_OWNER", columnList = "ownerId"),
    @Index(name = "IDX_ACCOUNT_STATUS", columnList = "status")
})
public class AccountRecord extends AuditableEntity {
    ...
    public AccountRecord(String reference, String ownerId, String status, BigDecimal amount, String details) {
