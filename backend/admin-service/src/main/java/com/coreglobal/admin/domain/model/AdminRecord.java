package com.coreglobal.admin.domain.model;
...
@Entity
@Table(name = "CGB_admin", indexes = {
    @Index(name = "IDX_ADMIN_OWNER", columnList = "ownerId"),
    @Index(name = "IDX_ADMIN_STATUS", columnList = "status")
})
public class AdminRecord extends AuditableEntity {
    ...
    public AdminRecord(String reference, String ownerId, String status, BigDecimal amount, String details) {
