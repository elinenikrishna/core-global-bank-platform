...
import com.coreglobal.admin.application.AdminApplicationService;
...
public class AdminController {
    ...
    public AdminController(AdminApplicationService service) { this.service = service; }

    @GetMapping(produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    public ApiEnvelope<Page<AdminRecord>> find(@RequestParam(required = false) String owner, Pageable pageable, HttpServletRequest request) {
