package com.coreglobal.notification.domain.model;
...
@Entity
@Table(name = "CGB_notifications", indexes = {
    @Index(name = "IDX_NOTIFICATION_OWNER", columnList = "ownerId"),
...
public class NotificationRecord extends AuditableEntity {
    ...
    public NotificationRecord(String reference, String ownerId, String status, BigDecimal amount, String details) {
