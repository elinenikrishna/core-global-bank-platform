...
import com.coreglobal.gateway.application.GatewayApplicationService;
...
public class GatewayController {
    ...
    public GatewayController(GatewayApplicationService service) { this.service = service; }

    @GetMapping(produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    public ApiEnvelope<Page<GatewayRecord>> find(@RequestParam(required = false) String owner, Pageable pageable, HttpServletRequest request) {
