package com.coreglobal.gateway.domain.model;
...
@Entity
@Table(name = "CGB_gateway", indexes = {
    @Index(name = "IDX_GATEWAY_OWNER", columnList = "ownerId"),
    @Index(name = "IDX_GATEWAY_STATUS", columnList = "status")
})
public class GatewayRecord extends AuditableEntity {
    ...
    protected GatewayRecord() {}
    public GatewayRecord(String reference, String ownerId, String status, BigDecimal amount, String details) {
