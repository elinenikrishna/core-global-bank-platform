package com.coreglobal.card.interfaces.rest;
...
import com.coreglobal.card.application.CardApplicationService;
...
public class CardController {
    ...
    public CardController(CardApplicationService service) { this.service = service; }

    @GetMapping(produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    public ApiEnvelope<Page<CardRecord>> find(@RequestParam(required = false) String owner, Pageable pageable, HttpServletRequest request) {
