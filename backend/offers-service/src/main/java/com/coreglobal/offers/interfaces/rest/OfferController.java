package com.coreglobal.offers.interfaces.rest;
...
import com.coreglobal.offers.application.OfferApplicationService;
...
public class OfferController {
    private final OfferApplicationService service;
    public OfferController(OfferApplicationService service) { this.service = service; }

    @GetMapping(produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    public ApiEnvelope<Page<OfferRecord>> find(@RequestParam(required = false) String owner, Pageable pageable, HttpServletRequest request) {
