package com.coreglobal.offers.domain.model;
...
@Entity
@Table(name = "CGB_offers", indexes = {
    @Index(name = "IDX_OFFERS_OWNER", columnList = "ownerId"),
    @Index(name = "IDX_OFFERS_STATUS", columnList = "status")
})
public class OfferRecord extends AuditableEntity {
    ...
    public OfferRecord(String reference, String ownerId, String status, BigDecimal amount, String details) {
